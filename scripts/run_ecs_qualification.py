"""Project sanitized ECS launch/runtime qualification evidence."""
...
def main() -> int:
    ...
    controls = launch_runtime_projection(manifest, evidence["results"], bindings)
    manifest = seal_launch_runtime_manifest(manifest, controls)
